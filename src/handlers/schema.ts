import { CollectionInfo, SchemaResponse, ScalarType, ObjectType} from "@hasura/ndc-sdk-typescript";
...
export function do_get_schema(configuration: Configuration): SchemaResponse {
    ...
    const mergedObjectTypes: { [key: string]: ObjectType} = { ...duckdbconfig.object_types};
